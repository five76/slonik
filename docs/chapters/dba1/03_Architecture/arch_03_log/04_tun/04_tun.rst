...
Кроме основной задачи — восстановления согласованности послесбоя — журнал можно использовать и для других целей, '
...
------------------+---------------+-----+-----------+-------------
 Storage          |            42 |   0 | 0/1FDD3F0 | CREATE
 Transaction      |            34 | 745 | 0/200EA08 | COMMIT
(2 rows)
...
.. figure:: img/tun_05.png
 ...
 resource_manager | record_length | xid | start_lsn | record_type 
------------------+---------------+-----+-----------+-------------
 Storage          |            42 |   0 | 0/201C1F0 | CREATE
 Heap             |            59 | 747 | 0/202CCD8 | INSERT+INIT
 Heap             |            59 | 747 | 0/2030588 | INSERT+INIT
 Heap             |            59 | 747 | 0/2033E20 | INSERT+INIT
 Heap             |            59 | 747 | 0/20376D0 | INSERT+INIT
 Heap             |            59 | 747 | 0/203AF80 | INSERT+INIT
 Heap             |            59 | 747 | 0/203E830 | INSERT+INIT
 Heap             |            59 | 747 | 0/20420E0 | INSERT+INIT
 Heap             |            59 | 747 | 0/2045978 | INSERT+INIT
 Heap             |            59 | 747 | 0/2049228 | INSERT+INIT
 Heap             |            59 | 747 | 0/204CAD8 | INSERT+INIT
 Heap             |            59 | 747 | 0/2050388 | INSERT+INIT
 Heap             |            59 | 747 | 0/2053C20 | INSERT+INIT
 Heap             |            59 | 747 | 0/20574D0 | INSERT+INIT
 Heap             |            59 | 747 | 0/205AD80 | INSERT+INIT
 Transaction      |           421 | 747 | 0/205BD00 | COMMIT
(16 rows)
...
.. note:: **Fsync** — параметр конфигурации PostgreSQL, который контролирует физическую запись обновлений на диск. По умолчанию значение fsync — on.
          Функция fsync — принудительно сбрасывать данные из дискового кэша ОС на диск после завершения транзакций. Это гарантирует, что данные на диске 
		  всегда в актуальном состоянии.

          **Fdatasync** — одно из возможных значений параметра wal_sync_method в PostgreSQL.
		  Вызов метода fdatasync() происходит после каждого завершения транзакции (COMMIT). При этом записывается на диск содержимое всех буферов данных, связанных с файлом.

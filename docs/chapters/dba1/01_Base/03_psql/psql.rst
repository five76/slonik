...
.. note:: **Сокет** (англ. socket — разъём) — программный интерфейс для обмена данными между процессами. Процессы могут выполняться как на одном компьютере, 
		  ...
		  а также закрывать соединения после завершения обмена данными. Они используются в различных типах сетевых приложений, включая веб-серверы, 
		  почтовые клиенты, мессенджеры.
